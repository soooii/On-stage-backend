...
//    private String kakaoClientSecret;
    ...
    public ClientRegistration naverClientRegistration() {
        ...
        return ClientRegistration.withRegistrationId("naver")
                ...
                .redirectUri("https://api.www.on-stage.link/login/oauth2/code/naver")
    ...
    public ClientRegistration googleClientRegistration() {
        return ClientRegistration.withRegistrationId("google")
                ...
                .redirectUri("https://api.www.on-stage.link/login/oauth2/code/google")
                .authorizationGrantType(AuthorizationGrantType.AUTHORIZATION_CODE)
                .scope("profile", "email")
...
//                .jwkSetUri("https://www.googleapis.com/oauth2/v2/jwks")
    ...
    public ClientRegistration githubClientRegistration() {
        return ClientRegistration.withRegistrationId("github")
                ...
                .redirectUri("https://api.www.on-stage.link/login/oauth2/code/github")
                .authorizationGrantType(AuthorizationGrantType.AUTHORIZATION_CODE)
    ...
    public ClientRegistration kakaoClientRegistration() {
        return ClientRegistration.withRegistrationId("kakao")
                ...
                .redirectUri("https://api.www.on-stage.link/login/oauth2/code/kakao")
                .authorizationGrantType(AuthorizationGrantType.AUTHORIZATION_CODE)
